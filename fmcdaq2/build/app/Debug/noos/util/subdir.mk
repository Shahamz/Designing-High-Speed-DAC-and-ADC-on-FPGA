...
C_SRCS += \
../noos/util/no_os_alloc.c \
../noos/util/no_os_clk.c \
../noos/util/no_os_mutex.c \
../noos/util/no_os_util.c 

OBJS += \
./noos/util/no_os_alloc.o \
./noos/util/no_os_clk.o \
./noos/util/no_os_mutex.o \
./noos/util/no_os_util.o 

C_DEPS += \
./noos/util/no_os_alloc.d \
./noos/util/no_os_clk.d \
./noos/util/no_os_mutex.d \
./noos/util/no_os_util.d 


# Each subdirectory must supply rules for building sources it contributes
noos/util/%.o: ../noos/util/%.c
	@echo 'Building file: $<'
